...
class FavoritesViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        TMDBClient.getFavorites(completionHandler: handleFavoritesResponse(favorites:error:))
    }
    ...
    private func handleFavoritesResponse(favorites: [Movie], error: Error?) {
        MovieModel.favorites = favorites
